...
2. Accept the licence agreement on [cds.climate.copernicus.eu/profile](https://cds.climate.copernicus.eu/profile) going on the "Licences" tab and select the "Licence to use Copernicus Products".
...
``` {r}
library(ecmwfr)
ecmwfr::wf_set_key("ade58c9d-5251-4979-9768-a75bc58192dd")
```
