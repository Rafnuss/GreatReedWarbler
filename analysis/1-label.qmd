...
Once you're done click **Save** to write the labeling file to `./data/tag-label/{id}-labeled.csv`.

### Run Trainset checks

Use the **Check** button in the trainset app header to run the built-in checks while you label. See [Trainset checks](https://raphaelnussbaumer.com/GeoPressureManual/labelling-tracks.html#trainset-checks) for more details.

### Run GeoPressureViz checks

Improve the label file until you can draw a coherent trajectory on GeoPressureViz. See [GeoPressureViz checks](https://raphaelnussbaumer.com/GeoPressureManual/labelling-tracks.html#geopressureviz-check) for more details.
